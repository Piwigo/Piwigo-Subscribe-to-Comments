<div id="the_header">
{'Subscribe to comments on %s'|@translate|sprintf:$STC.GALLERY_TITLE}</b>
</div>

<div id="the_content">

<p>{'You requested to subscribe by email to comments on %s'|@translate|sprintf:$STC.element.on}.</p>
