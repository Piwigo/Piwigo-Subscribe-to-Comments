...
$lang['all pictures of this album'] = 'Όλες οι εικόνες από αυτό το λεύκωμα';
$lang['comments on a picture'] = 'σχόλια για μια εικόνα';
$lang['comments on all pictures of an album'] = 'σχόλια σχετικά με όλες τις εικόνες ενός λευκώματος';
$lang['comments on an album'] = 'σχόλια για ένα άλμπουμ';
$lang['the album <a href="%s">%s</a>'] = 'το λεύκωμα <a href="%s">%s</a>';
